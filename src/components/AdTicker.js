  ...
  return(
    <div className="ticker">
          <Ticker isNewsTicker={true}>
            <NewsTicker id="1"  title="KICKSTER - live streaming solutions for futuristic beings   |   Create your own personalized watch list at www.kicksta.netlify.app/create   |   BruceDropEmOff & xQc sign 2yr / $100M deal with Kick   |   Who is the next big signing?" url=" https://metro.co.uk/2020/02/22/blue-passports-issued-brits-first-time-decades-next-months-12281012/?ito=newsnow-feed" />
