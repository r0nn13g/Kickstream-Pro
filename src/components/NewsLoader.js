...
const NewsLoader = () => {
  ...
  useEffect(() => {
      axios.get(`https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=100&q=NickWhite&type=video&key=${process.env.REACT_APP_API_KEY}`)
      .then((response) => {
  ...
  return(
    <div>
         <h6 style={{color: "var(--green-elements)", backgroundColor: "rgb(40, 40, 40)", fontWeight: "900", textAlign: "center", margin: "0px"}}>@nickwhite via Youtube</h6>
